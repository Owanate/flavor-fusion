            ...
            <div class="col-sm-8 col-lg-7">
              <div class="card-body pe-md-0 text-center text-sm-start">
                ...
                <p class="card-text mb-0 fs-6">
                  ...
                  <span id="nutrition">${result.nutrition.properties[3].amount.toFixed(
                    0
                  )}%</span>
                </p>
                <p class="card-text mb-0 fs-6">
                ...
                <div class="d-grid col-12 col-sm-8 mt-3">
                  <a href="../pages/instructions.html?id=${
                    result.id
                  }" class="btn fw-semibold d-flex align-items-center justify-content-center" id="recipe-link" target="_blank">
                    Recipe
